    ...
    return (
      <section className="canvas canvas--empty">
        <div className="empty-panel">
          <div className="session-header__eyebrow">{t("newThread.title")}</div>
          <h1>{t("newThread.emptyTitle")}</h1>
          <p>{t("newThread.emptyDescription")}</p>
        </div>
      </section>
    );
  }
        ...
        <div className="new-thread__composer composer">
          <div className="conversation conversation--composer">
            <ComposerSurface
              ...
              textareaPlaceholder={t("newThread.promptPlaceholder")}
              footer={(
        ...
        <div className="composer__footer-row">
          <div className="composer__hint new-thread__hint">
            <div className="new-thread__environment-group">
              ...
              >
                <span>{t("newThread.modeLocal")}</span>
              </button>
              <button
              ...
              >
                <span>{t("newThread.modeWorktree")}</span>
              </button>
            </div>
          ...
          <div className="composer__actions">
            ...
            />
            <button
              aria-label={t("newThread.attachFiles")}
