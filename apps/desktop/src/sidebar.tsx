...
import { ArchiveIcon, ChevronDownIcon, ExtensionIcon, FolderIcon, GitIcon, PinIcon, PlusIcon, RestoreIcon, SettingsIcon, SkillIcon, WorktreeIcon } from "./icons";
...
interface SidebarProps {
  ...
  readonly onOpenGit: (workspaceId?: string) => void;
      ...
      <div className="sidebar__top">
        ...
        <div className="sidebar__nav">
          ...
          <button
            className="sidebar__nav-item"
            type="button"
            onClick={() => onOpenGit(selectedWorkspace?.rootWorkspaceId ?? selectedWorkspace?.id)}
          >
            <GitIcon />
      ...
      <div className="sidebar__section">
        ...
        {visibleWorkspaces.length === 0 ? (
          <div className="empty-state" data-testid="empty-state">
            ...
            <p>{t("sidebar.noFoldersDescription")}</p>
            <button
...
const ThreadSessionRow = forwardRef<HTMLDivElement, ThreadSessionRowProps>(function ThreadSessionRow({
  ...
  return (
          ...
          >
            ...
            {threadMenu.menuSessionId === thread.session.id ? (
              <div className="workspace-menu session-row__menu" role="menu">
                ...
                >
                  {archived ? t("sidebar.restore") : t("sidebar.archiveAction")}
                </button>
    ...
    {threadMenu?.renameSessionId === thread.session.id ? (
      ...
      >
        <input
          aria-label={t("sidebar.renameThreadWithName", { name: thread.session.title })}
          className="workspace-rename__input"
