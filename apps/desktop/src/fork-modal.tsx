    ...
    >
      ...
      >
        <div className="tree-modal__header">
          <div>
            <div className="tree-modal__eyebrow">{t("forkModal.title")}</div>
            <h2 className="tree-modal__title">{t("forkModal.subtitle")}</h2>
          </div>
          <button
            aria-label={t("forkModal.close")}
        ...
        <div className="tree-modal__summary-step">
          ...
          <div className="new-thread__environment-group" role="radiogroup" aria-label={t("forkModal.environment")}>
            <button
            ...
            >
              <span>{t("forkModal.sameWorktree")}</span>
            </button>
            <button
              ...
              title={canUseWorktree ? undefined : t("forkModal.cantCreateWorktrees")}
              type="button"
              onClick={() => setEnvironment("worktree")}
            >
              <span>{t("forkModal.newWorktree")}</span>
            </button>
          </div>
          ...
          <div className="tree-modal__footer">
            <div className="tree-modal__hint">
              {environment === "worktree"
                ? t("forkModal.newWorktreeHint")
                : t("forkModal.sameWorktreeDescription")}
            </div>
            <div className="tree-modal__actions">
              ...
              >
                {submitting ? t("forkModal.forking") : t("forkModal.forkThread")}
              </button>
            </div>
          </div>
        </div>
